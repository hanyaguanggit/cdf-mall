...
public class RedisOpsUtil {
     ...
     * @return
     */
    public boolean redLock(String key, int value, long releaseTime) {
        key = "red_" + key;
        // 尝试获取锁
        Boolean boo = redisTemplate.opsForValue().setIfAbsent(key, value, releaseTime, TimeUnit.SECONDS);
        // 判断结果
     ...
     * @param key
     */
    public void deleteRedLock(String key) {
        key = "red_" + key;
        // 删除key即可释放锁
        redisTemplate.delete(key);
    }
    ...
    /**
     * description: 根据前缀获取所有的key 例如：pro_*
     * @Param:
     * @Return:
     * @Author: hanyaguang
     * @Date: 2022/1/28 13:40
     */
     ...
     * @return
     */
    public List<String> multiGet(String prefix){
