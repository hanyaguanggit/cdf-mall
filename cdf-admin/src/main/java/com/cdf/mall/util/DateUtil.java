...
public class DateUtil {
  ...
  /*  public static Date parse(String formatDate, String pattern) throws ParseException {
     ...
     * @return
     */
    public static String getDateFormatFroUserAuthte(String formatStr, Date date) {
        if (null == date) {
            return "";
        }
    ...
    public static String getDateAddDay(Date date, int n) {
        ...
        return getDateFormatFroUserAuthte(format3, d);
    }
     ...
     * @throws ParseException
     */
    public static Date getDateFroUserAuthys(int days) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @throws ParseException
     */
    public static String getDateFormatFroUserAuthys(int days, String formatStr) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @return
     */
    public static Date getDateFroUserAuthysAndTime(int days, int time) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @return
     */
    public static String getDateFormatFroUserAuthysAndTime(int days, int time, String formatStr) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @return
     */
    public static int getDaysFroUserAuthte(Date date) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @return
     */
    public static int getDaysFroUserAuthteFormat(String dateFormat) {
        Date beginDate = null;
        long time = 0;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
    ...
    public static int getDaysFroUserAuthteFormat(String dateFormat, String format) {
    ...
    public static boolean isWeekDay(Integer inTime) {
        Date d = getDateFroUserAuthys(inTime);
     ...
     * @return
     */
    public static long getTimeStampFroUserAuthysAndTime(int days, int time) {
        Date beginDate = null;
        try {
            beginDate = sdfFormat().parse(beginDateStr);
        } catch (ParseException e) {
     ...
     * @return
     */
    public static long getDateTimeFroUserAuthys(int days) {
        return getDateFroUserAuthys(days).getTime();
    }
