...
@FeignClient(value = "cdf-admins",path = "/admin/sso" , fallbackFactory = CsAdminSecurityUserServiceFallbackFactory.class )
public interface CsAdminSecurityUserFeignService {
    ...
    @ResponseBody
    CommonResult<CsSecurityUserRespVo> getSecurityAdminUser(@RequestBody ReqSecurityUserVo csMemberReqVo);
}