...
import com.cdf.mall.enums.EnumMethod;
...
public class HttpRequestUtil {
	...
	public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr) {
		log.info("httpRequest请求发起，requestMethod：{}，outputStr：{}",requestMethod,outputStr);
	 ...
	 * @return
	 */
	public static byte[] httpsRequest_byte(String requestUrl, String requestMethod, byte[] data) {
