package com.cdf.mall.util.security;

import com.cdf.mall.common.ResultCode;
import com.cdf.mall.exception.GateWayException;
...
public class JwtUtils {
     ...
     */
    private static final String CLIENT_ID = "cdf";
     ...
     */
    private static final String AUTH_TOKEN_KEY_URL = "http://cdf-securityauth/oauth/token_key";
    ...
    public static Claims getClaimsFromToken(String token) {
        Claims claims = null;
        token = StringUtils.substringAfter(token, AUTH_HEADER);
        try {
            SecretKey key = generalKey("KJHUhjjJYgYUllVbXhKDHXhkSyHjlNiVkYzWTBac1Yxkjhuad");
            claims = Jwts.parser()
                    .setSigningKey(key)
